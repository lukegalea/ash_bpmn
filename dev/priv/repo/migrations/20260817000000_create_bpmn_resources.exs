...
defmodule AshBpmnDev.Repo.Migrations.CreateBpmnResources do
  @moduledoc """
  The demo app's schema: the six BPMN tables a host instantiates, plus the
  demo's own subject table.
  """
  ...
  def up do
    ...
    create table(:dev_access_requests, primary_key: false) do
      add :id, :uuid, primary_key: true, default: fragment("gen_random_uuid()")
  ...
  def down do
    drop table(:dev_access_requests)
