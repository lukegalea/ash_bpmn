...
defmodule AshBpmn.Compiler.Xml do
  ...
  @supported_node_types ~w(startEvent endEvent userTask serviceTask sendTask businessRuleTask exclusiveGateway parallelGateway intermediateCatchEvent boundaryEvent intermediateThrowEvent callActivity receiveTask)
